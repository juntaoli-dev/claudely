...
export class ShortcutSettingsView extends LitElement {
    static styles = css`
        * { font-family:'Helvetica Neue',-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,sans-serif;
        ...
        .action-btn{background:none;border:none;color:rgba(var(--accent-rgb, 236, 72, 153), .8);
        ...
        .shortcut-input:focus,.shortcut-input.capturing{
            outline:none;border-color:rgba(var(--accent-rgb, 236, 72, 153), .6);
            box-shadow:0 0 0 1px rgba(var(--accent-rgb, 236, 72, 153), .3);}
        ...
        .settings-button.primary{background:rgba(var(--accent-rgb, 236, 72, 153), .25);border-color:rgba(var(--accent-rgb, 236, 72, 153), .6);}
        .settings-button.primary:hover{background:rgba(var(--accent-rgb, 236, 72, 153), .35);}
